...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white pt-3 pb-3 position-fixed w-100">
      <div class="container">
        <a class="navbar-brand fw-bold" href="#">Data Admin</a>
            ...
            <tbody>
                ...
                <?php foreach ($admin as $a) :?>
                  <tr>
                    ...
                    <td scope="col"><img src="asset/img/<?php echo $a['foto_admin'] ?>" width="100px" height="100px"></td>
                    <td scope="col"><?php echo $a['nama_admin'] ?></td>
                    <td scope="col"><?php echo $a['email_admin'] ?></td>
